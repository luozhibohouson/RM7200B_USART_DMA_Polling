#ifndef __DEFINE_SELF_TEST_ZHONGRUI_H
#define __DEFINE_SELF_TEST_ZHONGRUI_H

#include "define.h"

#if Magic_Cool_Customer == Self_Test_zhongrui
...
#define CURRENT_ADC_MIN             0 // 15 //DISABLE 为0则关闭空载检测
// ================================================
