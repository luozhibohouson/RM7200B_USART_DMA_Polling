...
#define ADC_CHANNEL_IGND   ADC_Channel_5 // ADC_Channel_6    // 低端电流
#define ADC_CHANNEL_VOUT   ADC_Channel_4 // ADC_Channel_7    // 输出电压
#define ADC_CHANNEL_IOUT   ADC_Channel_5 // ADC_Channel_6    // 输出电流
