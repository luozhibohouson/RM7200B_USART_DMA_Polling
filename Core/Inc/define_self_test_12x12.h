#ifndef __DEFINE_SELF_TEST_12X12_H
#define __DEFINE_SELF_TEST_12X12_H

#include "define.h"

#if Magic_Cool_Customer == Self_Test_12x12

// =================== 电压设定 ===================
#define     VOL_TARGET      60  // 流量目标
...
// =================== 气泵频率设定 ===================
//NOTE: 12*12的气泵范围只能设到20KHz~26KHz
