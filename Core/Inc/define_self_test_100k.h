#ifndef __DEFINE_SELF_TEST_100K_H
#define __DEFINE_SELF_TEST_100K_H

#include "define.h"

#if Magic_Cool_Customer == Self_Test_100K

// TODO:!!!!!! adc 采样个数不同，该h文件只适用于100K气泵测试，否则电压采样不行 !!!!!!!

// =================== 电压设定 ===================
  #define     VOL_TARGET      (31*2) //40  // 流量目标
...
// =================== 气泵频率设定 ===================
#define FREQ_MIN                   99000
#define FREQ_MAX                   101000
// ================================================
